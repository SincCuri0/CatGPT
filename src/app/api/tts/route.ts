...
async function handleGroqTTS(text: string, voice: string, audioDir: string, debugEnabled: boolean) {
...
async function handleNativeEdgeTTS(text: string, voice: string, audioDir: string, debugEnabled: boolean) {
