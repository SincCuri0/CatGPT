...
function buildPlannerPrompt(
    ...
    return [
        ...
        "      \"systemPrompt\": \"string\",",
        "      \"tools\": [\"web_search\"|\"shell_execute\"|\"mcp_all\"|\"subagents\"],",
...
export async function executeAgentsCreateCatsPost(req: NextRequest, debugEnabled: boolean): Promise<Response> {
    try {
        ...
        const providerSearchOrder = [
            preferredProvider,
            ...Object.keys(apiKeys).filter((providerId) => providerId !== preferredProvider),
        ];
